...
const Sidebar = () => {
    ...
    return (_jsxs("nav", { className: "sidebar", children: [_jsxs("div", { className: "sidebar-header", children: [_jsx("h2", { className: "sidebar-title", children: "awatansh.dev" }), _jsx("p", { className: "sidebar-subtitle", children: "Developer Portfolio" })] }), _jsxs("div", { className: "sidebar-nav", children: [navItems.map((item) => (_jsxs(NavLink, { to: item.path, title: item.label, className: ({ isActive }) => `sidebar-link ${isActive ? "sidebar-link-active" : ""}`, children: [_jsx("span", { className: "sidebar-icon", children: item.icon }), _jsx("span", { className: "sidebar-label", children: item.label })] }, item.path))), resumeLink && resumeLink !== "https://drive.google.com/file/d/YOUR_ID/view" && (_jsxs("a", { href: resumeLink, target: "_blank", rel: "noopener noreferrer", title: "Resume", className: "sidebar-link sidebar-link-external", children: [_jsx("span", { className: "sidebar-icon", children: "\uD83D\uDCC4" }), _jsx("span", { className: "sidebar-label", children: "\uD83D\uDCDA Resume" }), _jsx("span", { className: "sidebar-external-icon", children: "\u2197" })] }))] }), _jsxs("div", { className: "sidebar-footer", children: [_jsx("p", { className: "sidebar-hint", children: "\uD83D\uDD17 Connect with me:" }), _jsx("div", { className: "sidebar-social-links", children: context?.socials.map((social, index) => {
