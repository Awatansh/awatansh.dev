    ...
    return (_jsxs("div", { className: "admin-dashboard-layout", children: [_jsxs("aside", { className: "admin-sidebar", children: [_jsxs("div", { className: "admin-brand", children: [_jsx("h2", { children: "\uD83D\uDCCA Admin Portal" }), _jsx("p", { className: "brand-subtitle", children: "Management Dashboard" })] }), _jsxs("nav", { className: "admin-nav", children: [_jsxs("button", { className: `nav-item ${activeSection === "inbox" ? "active" : ""}`, onClick: () => {
                                    ...
                                    setActiveSection("projects");
                                        ...
                                        return (_jsxs(_Fragment, { children: [_jsxs("div", { className: "card-header", children: [_jsx("h3", { children: social.name }), _jsx("button", { onClick: () => deleteSocial(index), className: "delete-small-btn", children: "\uD83D\uDDD1\uFE0F" })] }), _jsxs("div", { className: "form-row", children: [_jsxs("div", { className: "form-group", children: [_jsx("label", { children: "Platform" }), _jsx("select", { value: selectedPlatform, onChange: (e) => {
                                                                    ...
                                                                    }, children: SOCIAL_PLATFORM_OPTIONS.map((platform) => (_jsx("option", { value: platform, children: platform }, platform))) })] }), _jsxs("div", { className: "form-group", children: [_jsx("label", { children: "URL" }), _jsx("input", { value: social.url, onChange: (e) => updateSocial(index, "url", e.target.value), placeholder: "https://..." })] })] }), selectedPlatform === "Other" && (_jsxs("div", { className: "form-group", children: [_jsx("label", { children: "Custom Platform Name" }), _jsx("input", { value: social.name, onChange: (e) => updateSocial(index, "name", e.target.value), placeholder: "Enter platform name" })] })), _jsxs("div", { className: "form-group", children: [_jsx("label", { children: "Icon (optional)" }), _jsx("input", { value: social.icon || "", onChange: (e) => updateSocial(index, "icon", e.target.value), placeholder: "/img/linkedin-logo.svg or https://..." })] })] }));
                                    })() }, index))) })] }))] })] }));
};
